...
from src.config import (CITIES, PROCESSED_DIR, RAW_DIR,
                         PATCH_SIZE_M, OPENTOPO_API_KEY)
...
def download_city_pois(city_name):
    """Download all POIs for a city from OSM."""
    ...
    print(f"  downloaded {len(combined)} POIs")
    return combined
